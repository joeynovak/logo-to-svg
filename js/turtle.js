function Turtle (canvasContext, options) {
    ...
    this.options = {
        x: 100,
        y: 100,
        updateTurtlePositionCallback: function(){}
    };
    ...
    this.max_x = this.options.x;
    this.max_y = this.options.y;
    this.updateTurtlePositionCallback = this.options.updateTurtlePositionCallback;
...
Turtle.prototype.update = function() {
    this.options.updateTurtlePositionCallback(this);
}
...
function DelayTurtle (speed, draw_bits) {
